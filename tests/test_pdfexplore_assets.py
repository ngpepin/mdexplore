...
class PdfExploreAssetTests(unittest.TestCase):
    ...
    def test_viewer_bridge_asset_exists(self) -> None:
        ...
        self.assertIn("persistent_highlight_fill_color", source)
        self.assertIn("rgba(102, 86, 178, 0.24)", source)
        self.assertIn("persistent_highlight_important_fill_color", source)
        self.assertIn("rgba(225, 214, 255, 0.36)", source)
